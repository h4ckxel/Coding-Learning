...
def main():
    ...
    """
    elementos = int(input("Ingresa el número de elementos para ordenar la lista: "))
    lista = [random.randint(0, 1000) for _ in range(elementos)]
    ...
    # instancia para crear algoritmos
    ordenaditos = Ordenamientos()
    ordenaditos.ordenar(lista, seleccion)
